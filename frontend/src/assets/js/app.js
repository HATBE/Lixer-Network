            ...
            headerHTML += `
                        ...
                        <span class="rounded-circle mx-3 dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><hr class="dropdown-divider"></li>
                                <li><span class="dropdown-item cursor-pointer" onclick="app._logout()"><span style="display: inline-block;width: 23px;"><i class="fas fa-sign-out-alt"></i></span> Logout</span></li>
                            </ul>
                        </span>
            `;
        } else {
            headerHTML += `
                        <a title="Login" class="mx-3 link-light hover-text-light" href="${rootPath}login"><i class="fas fa-sign-in-alt"></i></a>
            `;
        }
        headerHTML += `
                        <span class="mx-3 dropdown">
